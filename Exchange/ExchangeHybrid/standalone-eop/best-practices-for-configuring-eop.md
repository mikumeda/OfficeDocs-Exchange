...
|[Use DKIM to validate outbound email sent from your custom domain in Office 365](/microsoft-365/security/office-365-security/use-dkim-to-validate-outbound-email)|Yes|Yes||
|[Use DMARC to validate email in Office 365](/microsoft-365/security/office-365-security/use-dmarc-to-validate-email)|Yes|Yes|Use `action=quarantine` for Standard, and `action=reject` for Strict.|
|Deploy the [Report Message add-in](/microsoft-365/security/office-365-security/enable-the-report-message-add-in) or the [Report Phishing add-in](/microsoft-365/security/office-365-security/enable-the-report-phish-add-in) to improve end-user reporting of suspicious email|Yes|Yes||
