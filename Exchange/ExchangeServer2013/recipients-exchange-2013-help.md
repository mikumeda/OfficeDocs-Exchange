...
The people and resources that send and receive messages are the core of any messaging and collaboration system. In an Exchange organization, these people and resources are referred to as _recipients_. A recipient is any mail-enabled object in Active Directory to which Microsoft Exchange can deliver or route messages.
...
|Mail forest contact|A mail contact that represents a recipient object from another forest. Mail forest contacts are typically created by Microsoft Identity Integration Server (MIIS) synchronization. <br/><br/> **Important**: Mail forest contacts are read-only recipient objects that are updated only through MIIS or similar custom synchronization. You can't use the EAC or the Shell to remove or modify a mail forest contact.|
|Mail user|A mail-enabled Active Directory user that represents a user outside the Exchange organization. Each mail user has an external email address. All messages sent to the mail user are routed to this external email address. <br/><br/> A mail user is similar to a mail contact, except that a mail user has Active Directory logon credentials and can access resources.|
...
|Site mailbox|A mailbox comprised of an Exchange mailbox to store email messages and a SharePoint site to store documents. Users can access both email messages and documents using the same client interface. For more information, see [Site mailboxes](site-mailboxes-exchange-2013-help.md).|
...
|Message approval|SystemMailbox {1f05a927-_xxxx_-_xxxx_-_xxxx_-_xxxxxxxxxxxx_} <br/><br/> where _x_ is a randomly assigned and unique number for each Exchange forest.|
...
- **Mail-enabled non-universal groups**: These are Active Directory global or local group objects that are mail-enabled. You can create or mail-enable only universal distribution groups. You may have mail-enabled groups that were migrated from previous versions of Exchange that aren't universal groups. These groups can still be managed by using the EAC or the Shell.
  ...
  > [!NOTE]
  > To convert a domain-local or a global group to a universal group, you can use the [Set-Group](/powershell/module/exchange/Set-Group) cmdlet in the Shell.
...
|Topic|Description|
|---|---|
|[Create user mailboxes](create-user-mailboxes-exchange-2013-help.md)|Learn how to create user mailboxes using the Exchange admin center or the Exchange Management Shell.|
|[Manage user mailboxes](manage-user-mailboxes-exchange-2013-help.md)|Learn how to create user mailboxes, change mailbox properties, and bulk-edit selected properties for multiple mailboxes.|
|[Manage linked mailboxes](manage-linked-mailboxes-exchange-2013-help.md)|Learn about the requirements for linked mailboxes, how to create and link them to a master account, and change linked mailbox properties.|
|[Create and manage distribution groups](manage-distribution-groups-exchange-2013-help.md)|Learn how to create and manage distribution groups, and create a group naming policy for your organization.|
|[Manage mail-enabled security groups](manage-mail-enabled-security-groups-exchange-2013-help.md)|Learn how to create and manage mail-enabled security groups.|
|[Manage dynamic distribution groups](manage-dynamic-distribution-groups-exchange-2013-help.md)|Learn how to create dynamic distribution groups and manage dynamic distribution group properties, such as using custom attributes and other properties to determine group membership.|
|[Manage mail contacts](manage-mail-contacts-exchange-2013-help.md)|Learn how to create and manage mail contacts.|
|[Manage mail users](manage-mail-users-exchange-2013-help.md)|Learn how to create and manage mail users.|
|[Create and manage room mailboxes](manage-room-mailboxes-exchange-2013-help.md)|Learn how to create room mailboxes and manage room mailbox properties, such as enabling recurring meetings and configuring booking and scheduling options.|
|[Manage equipment mailboxes](manage-equipment-mailboxes-exchange-2013-help.md)|Learn how to create equipment mailboxes, configure booking and scheduling options, and manage other mailbox properties.|
|[Disconnected mailboxes](disconnected-mailboxes-exchange-2013-help.md)|Learn about the two types of disconnected mailboxes and how to work with them.|
|[Custom attributes](custom-attributes-exchange-2013-help.md)|Learn how to add information about a recipient by using custom attributes.|
...
|[Manage permissions for recipients](manage-permissions-for-recipients-exchange-2013-help.md)|Learn how to use the EAC or the Shell to assign permissions to users and groups.|
|[Automatic mailbox distribution](automatic-mailbox-distribution-exchange-2013-help.md)|Learn about how automatic mailbox distribution works and how to control which mailbox databases are selected for new and moved mailboxes.|
