...
After the import process is complete, you may also configure the settings by using the **Set-TransportConfig** cmdlet. For more information, see [Set-TransportConfig](/powershell/module/exchange/Set-TransportConfig).
...
|**GenerateCopyOfDSNFor**|This attribute specifies the delivery status notification (DSN) codes that cause the DSN message to be copied to the postmaster email address. DSN codes are entered as _x.y.z_ and are separated by commas.|5.4.8, 5.4.6, 5.4.4, 5.2.4, 5.2.0, 5.1.4|
