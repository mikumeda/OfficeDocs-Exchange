...
ms:mtpsurl: https://technet.microsoft.com/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 49289280
ms.reviewer: 
manager: serdars
ms.author: serdars
ms.topic: article
description: The Journaling management role lets admins control journal rules in an org
author: msdmaguire
f1.keywords:
- NOCSH
