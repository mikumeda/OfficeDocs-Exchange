...
|---|:---:|:---:|---|---|---|---|
|[Data Loss Prevention role](data-loss-prevention-role-exchange-2013-help.md)|X||`Organization`|`Organization`|`OrganizationConfig`|`OrganizationConfig`|
|[Information Rights Management role](information-rights-management-role-exchange-2013-help.md)|X||`Organization`|`Organization`|`OrganizationConfig`|`OrganizationConfig`|
|[Retention Management role](retention-management-role-exchange-2013-help.md)|X||`Organization`|`Organization`|`OrganizationConfig`|`OrganizationConfig`|
|[View-Only Audit Logs role](view-only-audit-logs-role-exchange-2013-help.md)|X||`Organization`|`None`|`OrganizationConfig`|`None`|
